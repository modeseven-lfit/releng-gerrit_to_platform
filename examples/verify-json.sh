...
##############################################################################
#
# Verifies gerrit_json against the schema
#
# Usage: verify-json.sh <gerrit_json_string>
#
# Example:
#   ./verify-json.sh '{"branch":"master","change_id":"I123...","change_number":"12345",...}'
#
##############################################################################
