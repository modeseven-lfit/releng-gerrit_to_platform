...
**In late 2024, GitHub increased this limit from 10 to 25 inputs.** This change
significantly eases the constraint, leaving 16 slots for custom parameters
alongside the 9 ``GERRIT_*`` inputs.
